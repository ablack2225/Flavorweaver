...
prep_time: 35m
cook_time: 30m
total_time: 1h 5m, plus marination
servings: 2 to 3 servings
measurement_status: documented

rating_note: Phenomenal
repeat_worthy: true
...
|---|---:|---:|---|
| Working Recipe | 1 hr 5 min, plus marination | 2 to 3 servings | Moderate |

| Prep Time | Cook Time | Rating Note | Repeat Worthy |
|---:|---:|---|---|
| 35 min | 30 min | Phenomenal | Yes |
...
| Marinade | Soy sauce, sesame oil, ginger, garlic, black pepper |
...
| Amount | Ingredient | Notes |
|---:|---|---|
| 1 | Egg white | Add after marination |
| 3 Tbsp | Cornstarch | Toss with marinated chicken and egg white |
...
| Bowl | Contents | Notes |
|---|---|---|
| Bowl 1 — Chicken | 3 boneless skinless chicken thighs, cut into bite-size pieces | Keep pieces even so they fry evenly. |
| Bowl 2 — Marinade | 3 Tbsp soy sauce; 1 Tbsp sesame oil; 1 1/2 tsp grated ginger; 4 minced garlic cloves; 1/2 tsp black pepper | Marinate chicken 6 to 24 hours. |
| Bowl 3 — Velveting | 1 egg white; 3 Tbsp cornstarch | Add after marination and before coating. |
| Bowl 4 — Dry Coating | 1/2 cup flour; 1/2 cup cornstarch; 1/2 tsp baking powder; 1/2 tsp salt | Whisk well before coating chicken. |
...
| Step | Action |
|---:|---|
| 1 | **Marinate the chicken.** Cut **3 boneless skinless chicken thighs** into bite-size pieces. Combine with **3 Tbsp soy sauce**, **1 Tbsp sesame oil**, **1 1/2 tsp grated ginger**, **4 minced garlic cloves**, and **1/2 tsp black pepper**. Marinate **6 to 24 hours**. |
| 2 | **Velvet the chicken.** Add **1 egg white** and **3 Tbsp cornstarch** to the marinated chicken. Toss until coated. |
| 3 | **Mix the dry coating.** Whisk together **1/2 cup flour**, **1/2 cup cornstarch**, **1/2 tsp baking powder**, and **1/2 tsp salt**. |
| 4 | **Coat the chicken.** Dredge the velveted chicken pieces in the dry coating. Shake off excess. |
...
Chef rating: **Phenomenal**.

Extra double-fried chicken can be frozen for future orange chicken. Keep sauce separate when freezing chicken so the coating can be re-crisped later.
