---
name: Bánh Mì Không-Style Dipping Rolls
category: Bread
status: Working Recipe
difficulty: Intermediate
prep_time: 20m
cook_time: 18m-22m
rise_time: 1h 35m-2h 15m
total_time: 2h 15m-3h
yield: 4 small rolls
measurement_status: documented
culture: Vietnamese Inspired
primary_category: breads
categories:
  - breads
...
# Bánh Mì Không-Style Dipping Rolls

> Vietnamese-style short dipping rolls with a thin crackly crust, light airy interior, and enough structure to tear and dip into Bò Kho broth.
...
|---:|---|---|
| 2 cups | All-purpose flour | Keeps crumb lighter |
| 1 cup | Bread flour | Adds dipping structure and chew |
| 2 tsp | Active dry yeast | Bloom before mixing |
| 1 tsp | Sugar | Feeds yeast |
| 1 1/4 cups | Water | Use 1 cup for bloom, remaining as needed |
| 1 1/2 tsp | Fine salt | Mix into dough |
| 1 Tbsp | Neutral oil | Keeps dough workable |
| 1 tsp | Fresh lime juice | Supports dough structure and brightness |
| As needed | Extra flour | For shaping |
| 1 cup | Hot water | For oven steam |

## Yeast Bloom Note

For the best active dry yeast bloom, use water between **105°F and 108°F**. Check with a thermometer when possible. Water that is too cool may slow or weaken the rise; water that is too hot can damage the yeast.
...
1. **Bloom the yeast.** In a large bowl, combine 1 cup water between 105°F and 108°F, sugar, and active dry yeast. Let sit 5-10 minutes, until foamy. If the yeast does not foam, stop and restart with fresh yeast before continuing.

2. **Mix the dough.** Add all-purpose flour, bread flour, salt, neutral oil, and lime juice. Mix until a shaggy dough forms. Add up to 1/4 cup additional warm water, 1 Tbsp at a time, only if the dough feels dry. The dough should be soft and slightly tacky, not stiff.

3. **Knead lightly.** Knead by hand for 5-7 minutes, or until smoother and elastic. Do not overwork into a dense bread dough. The goal is light structure, not heavy chew.
...
10. **Cool briefly.** Let rolls cool at least 10-15 minutes before tearing open. Serve warm with Bò Kho for dipping.
...
None. This bread is itself a required component for Vietnamese Bò Kho-Style Brisket Stew Meal.

## Chef's Notes

These rolls are designed for Bò Kho broth. They should not be enriched like soft dinner rolls and should not be seasoned with herbs. The flavor should stay clean so the bread can carry the stew.

All-purpose flour keeps the interior light. Bread flour adds enough structure for dipping.
...
**Protect:** crisp crust, airy crumb, light chew, and fresh-baked service close to stew plating.

**Evaluate after cooking:** crust shatter, crumb openness, dipping strength, rise timing, and whether 4 rolls are the right yield for 4 hearty stew servings.
