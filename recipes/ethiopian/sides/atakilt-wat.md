...
|---|---:|---:|---|
| Working Recipe | 40m | 2-4 side servings | Easy |

| Prep Time | Cook Time | Rating Note | Repeat Worthy |
|---:|---:|---|---|
| 15m | 25m | Mild vegetable side for the Doro Wat platter | Yes |
...
Yes. This belongs as a required vegetable component in the Ethiopian-inspired platter.
...
| Layer | Notes |
|---|---|
| Richness | Butter or oil |
| Freshness | Cabbage and carrot |
| Acid / Brightness | None; handled by timatim salad |
| Heat | None |
