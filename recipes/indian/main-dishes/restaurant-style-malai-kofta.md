---
name: Restaurant-Style Malai Kofta
...
|---:|---:|---|---|
| 30 min | 40 min | House favorite | Yes |
...
| Kofta Base | Boiled potato, paneer, cornstarch, salt, garam masala or cardamom powder |
| Kofta Flavor Mix | Cashews, raisins, ginger, green chilies or black pepper, coriander leaves |
...
|---:|---|---|
| 1 1/2 Tbsp | Neutral oil or ghee | For sauteing |
| 2 to 3 | Green cardamoms | Optional but recommended |
| 1 small | Bay leaf | Optional; discard before blending |
| 1/2 inch | Cinnamon stick | Optional |
| 2 | Cloves | Optional |
| 3/4 tsp | Cumin seeds or shahi jeera | Optional |
| 1 1/2 cups | Onion | About 1 large onion, sliced |
| 1 inch | Ginger | Peeled and sliced, or 1 Tbsp ginger-garlic paste |
| 5 to 6 large cloves | Garlic | About 12 grams |
| 2 1/4 cups | Ripe red tomatoes | Sliced or chopped |
| 18 | Raw cashews | Sub with 1/4 cup heavy cream only if needed |
...
| Amount | Ingredient | Notes |
|---:|---|---|
| 3/4 tsp | Kashmiri red chili powder | Add more only for color |
| 3/4 to 1 tsp | Garam masala | Adjust to taste |
| 1 tsp | Coriander powder | Ground coriander seeds |

### Gravy Blend and Finish

| Amount | Ingredient | Notes |
|---:|---|---|
| 1 cup | Cold water | For blending gravy base |
| 1/2 cup | Water | Add during final simmer; omit if gravy is already loose |
| 2 Tbsp | Unsalted butter | For finishing gravy |
| 1 Tbsp | Jaggery powder or sugar | Balances tomato acidity |
| 1 1/2 tsp | Kasuri methi | Crushed between palms |
| 1/4 cup | Heavy cream | Double if not using cashews; reserve 1 Tbsp to garnish if desired |
| 1 Tbsp | Coriander leaves | Chopped, optional garnish |
...
| Amount | Ingredient | Notes |
|---:|---|---|
| 1 Tbsp | Cashews | Fine chopped; about 8 cashews, optional |
| 1 Tbsp | Raisins | Fine chopped; about 8 to 10 raisins, optional |
| 1 tsp | Grated ginger or ginger paste |  |
| 1 to 2 | Green chilies | Deseeded and chopped, or use 1/2 tsp black pepper |
...
| As needed | Warm malai gravy | Keep warm, not boiling hard |
| As desired | Cream | Garnish |
| As desired | Coriander leaves | Garnish |
...
| Bowl | Contents | Notes |
|---|---|---|
| Bowl 1 — Whole Spice Bloom | 2 to 3 green cardamoms; 1 small bay leaf; 1/2 inch cinnamon; 2 cloves; 3/4 tsp cumin seeds or shahi jeera | Optional but recommended for restaurant-style depth. Discard bay leaf before blending. |
| Bowl 2 — Onion Base | 1 1/2 cups sliced onion | Saute until light golden. |
| Bowl 3 — Ginger Garlic | 1 inch sliced ginger and 5 to 6 garlic cloves, or 1 Tbsp ginger-garlic paste | Add after onion softens. |
| Bowl 4 — Tomato Cashew Base | 2 1/4 cups tomatoes; 18 raw cashews; 3/4 tsp sea salt | Cook until tomatoes are soft and mushy. |
| Bowl 5 — Gravy Spices | 3/4 tsp Kashmiri chili powder; 3/4 to 1 tsp garam masala; 1 tsp coriander powder | Add after tomato-cashew base softens. |
| Bowl 6 — Blend Water | 1 cup cold water | Helps cool and blend the gravy base smooth. |
| Bowl 7 — Gravy Finish | 2 Tbsp butter; 1 Tbsp jaggery or sugar; 1 1/2 tsp kasuri methi; 1/4 cup cream; coriander leaves | Add after strained gravy simmers thick and creamy. |
...
| Bowl 5 — Finished Kofta Hold | Cooling rack or steel colander | Keep koftas crisp and lifted after frying. |
...
| Layer | Build Detail |
|---|---|
| 1. Warm Gravy Base | Spoon warm, silky malai gravy into the serving dish first. The gravy should be thick enough to hold the koftas but loose enough to pool. |
| 2. Kofta Placement | Place fried koftas gently into the warm gravy right before serving. Do not boil koftas in the gravy. |
| 3. Cream Finish | Drizzle a little cream over the top for the restaurant-style finish. |
| 4. Herb Finish | Add chopped coriander leaves if desired. |
| 5. Bread or Rice | Serve with Fluffy Skillet Naan, plain basmati rice, jeera rice, tandoori roti, or kulcha. |

## Final Taste Target

The finished malai kofta should be rich, creamy, gently sweet, warmly spiced, and silky smooth.

The koftas should be crisp outside, soft and paneer-rich inside, and tender enough to cut with a spoon without falling apart in the gravy.
...
| Rice | Plain Basmati Rice | Simple base for the rich gravy. |
| Rice | Jeera Rice | Cumin rice pairs beautifully with the creamy sauce. |
| Bread | Tandoori Roti or Kulcha | Traditional-style options. |

## Chef's Notes

This is a house favorite and should stay organized for smooth kitchen execution. The key is separating gravy work from kofta work, then bringing them together only at the end.
